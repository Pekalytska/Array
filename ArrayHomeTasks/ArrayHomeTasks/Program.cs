...
namespace ArrayHomeTasks
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //add additinal element second variant
            Console.WriteLine("Initional array:");
            int[] ArrAdd2 = { 3, 5, 7 };
            for (int y = 0; y < 3; y++)
            {
                Console.Write(ArrAdd2[y] + " ");
            }
            Console.WriteLine();
            Console.WriteLine("Enter additional number of array:");
            int additElem = Int32.Parse(Console.ReadLine());
            int[] ArrAdd3 = new int[4];
